export default {
  id: 'screen-list',
  title: '화면 구현 — 목록 조회',
  description: '조회 화면에서 가장 자주 나오는 전체 목록, 집계 결과, 조건 검색 패턴을 JSP 테이블 출력 구조 기준으로 정리합니다.',
  lessons: [
    {
      id: 'list_01',
...
DAO에서 가져온 리스트가 JSP 테이블 행으로 바뀌는 구조를 확인해보세요.`,
      type: 'live-jsp',
      language: 'html',
...
집계 결과를 화면용 문자열로 가공해 출력하는 구조를 확인해보세요.`,
      type: 'live-jsp',
      language: 'html',
      starterCode: `<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
...
검색 폼, 파라미터 분기, 결과 없음 처리, 조건별 테이블 출력 구조를 같이 확인해보세요.`,
      type: 'live-jsp',
      language: 'html',
      starterCode: `<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
